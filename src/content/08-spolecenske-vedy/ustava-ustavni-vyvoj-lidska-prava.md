---
title: "USTAVA, USTAVNI VYVOJ, LIDSKA PRAVA"
order: 14
source: "MATURITA HADR/Společenské vědy/14. USTAVA, USTAVNI VYVOJ, LIDSKA PRAVA.docx"
---
__ČESKÝ ÚSTAVNÍ VÝVOJ__
...
\- nejvýznamnějším mezníkem v dějinách naší ústavnosti bylo přijetí __prosincové ústavy__ roku 1867 –
   byla složena ze __6 zákonů:__ \- První uzákonil říšskou radu \(složenou z poslanecké a panské sněmovny\)
...
__2\. Druhá etapa__
\- po vzniku ČSR došlo hned v listopadu ke schválení tzv\. __Prozatímní ústavy__, jež upravovala činnost
...
\- za vzor byla vzata Ústava Francouzské republiky – naši představitelé tak dali přednost systému
   __parlamentnímu před prezidentským__ systémem USA
...
\- zákonodárnou moc představovalo __dvoukomorové Národní shromáždění__, složené z __Poslanecké
  sněmovny __\(300 poslanců volených na 6 let, aktivní právo od 21, pasivní od 30 let\) a__ Senátu__ \(150
  senátorů volených na 8 let s aktivním volebním právem od 26 a pasivním od 45 let\)
\- obě komory byly voleny stejným \(__poměrným__\) volebním systémem a byly rozpustitelné – to přispělo
  k tomu, že se Senát v prvorepublikové ústavě neosvědčil
\- hlavou státu byl __prezident__, volený společnou schůzí obou komor na dobu 7 let – výjimka z tohoto
...
\- jakýkoliv prezidentův úkon vyžadoval ke své platnosti __spolupodpis odpovědného člena vlády__
\- prezidenta nešlo ze své funkce odvolat, v případě, že by nemohl svou funkci vykonávat, by převzala
   jeho pravomoci vláda
\- __vláda__ byla odpovědna Poslanecké sněmovně, která ji mohla __vyslovit nedůvěru__ \(zásada
...
\- __Mnichovská dohoda__ z 29\.\-30\.9\. 1938 znamenala fakticky konec československé suverenity
...
\- v prosinci 1938 došlo k totalitní likvidaci ústavnosti a demokracie vůbec, když byl schválen ústavní
  zákon, __který dával právo vládě nahradit zákony zákonnými opatřeními a prezidentovi pravomoc
  vydávat dekrety se silou ústavních zákonů__
...
\- dalším mezníkem naší ústavnosti byla __Ústava 9\.května 1948__ – znamenala vznik SNR, národních
...
\- její významnou změnou byl ústavní zákon o __Československé federaci__ \(1968\) – upravoval vznik dvou
...
\- __FS bylo složeno ze Sněmovny lidu__ \(200 poslanců, v r\.1990 sníženo na 150, volilo se z celé federace\)
  __a Sněmovny národů__ \(150 poslanců, 75 z ČSR a 75 ze SR\)
...
__LIDSKÁ PRÁVA__
__Všeobecná deklarace lidských práv__
...
30\. nikdo nemá právo upírat někomu žádné z uvedených práv__
...
\- Listina má 44 článků členěných do 6 hlav:
        \- __Hlava první__ garantuje některá práva
        \- __Hlava druhá__ obsahuje katalog základních lidských práv a svobod
        \- __Hlava třetí__ upravuje práva národnostních menšin
        \- __Hlava čtvrtá__ hospodářská, sociální a kulturní práva
        \- __Hlava pátá__ se zabývá právem na soudní a jinou právní ochranu
        \- __Hlava šestá__ upravuje společná ustanovení
...
\- __16\.12\.1992__ __Listina prohlášena za součást ústavního pořádku ČR__

__KBSE = Konference o bezpečnosti a spolupráci v Evropě__
...
\- dokument obsahoval 3 „koše“ problémů:
     __1\. se týkal evropské bezpečnosti__ – jednotlivé země se zde zřekly použití síly při řešení
                                                                    mezinárodních problémů, byla zde konstatována neměnnost
                                                                    hranic a nezasahování do vnitřních záležitostí jiných států
     __2\. se věnoval otázkám spolupráce__ v oblastech kultury, hospodářství, vědy, nových technologií a
                                                                    životního prostředí
     __3\. se věnoval otázkám humanitárním__, problémům volné výměny informací, kontaktům mezi členy
...
__VONS = Výbor na obranu nespravedlivě stíhaných__
