...
$$S = n \cdot S_{\text{trojúhelníka}} \qquad \text{(} n \text{ = počet trojúhelníků)}$$

$$o = n\cdot a \qquad \text{(} a \text{ = strana n-úhelníka)}$$

$$\alpha = \frac{360°}{n} \qquad \text{(úhel u středu v každém z dílčích trojúhelníků)}$$
...
**2.** Vyřešte obvod a obsah pravidelného pětiúhelníka o hraně $a=6\text{ cm}$.

Výsledek: ||o = 5a = 30 cm; S ≈ 61,95 cm²||

**3.** Vyřešte obvod a obsah pravidelného šestiúhelníka o hraně $a=4\text{ cm}$.

Výsledek: ||o = 6a = 24 cm; S ≈ 41,52 cm² (šestiúhelník = 6 rovnostranných trojúhelníků o straně 4 cm)||

**4.** Vyřešte poloměr kružnice vepsané a opsané pravidelnému osmiúhelníku o hraně $a=5\text{ cm}$.
