...
- **b)** ||a+2c||
- **c)** ||10-90x⁴b²+27x³b||
- **d)** ||dochovaný dělenec neseděl s dochovaným výsledkem — zpětným dosazením vychází, že správný dělenec musel být (-24y²z²-12y⁴z³+6y³z⁵):(6y²z²) = -4-2y²z+yz³||
...
- **b)** ||m+11||
- **c)** ||3m-4||
- **d)** ||-2p-2 (všechny čtyři vychází beze zbytku)||
...
- **a)** ||7y+2, zbytek 4, tedy 7y+2+4/(y-7)||
- **b)** ||4m²+9m+29, zbytek 86, tedy 4m²+9m+29+86/(m-3)||
- **c)** ||po seřazení -k³+10k²-4k+2: podíl -k²-4, zbytek -38, tedy -k²-4-38/(k-10)||
- **d)** ||4a²+4a-1, zbytek 5, tedy 4a²+4a-1+5/(3a-3)||
