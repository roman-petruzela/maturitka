...
Řešení (dochovaný postup): výraz $\approx10^5\cdot(0{,}2525252-0{,}2050505)=10^5\cdot0{,}0474747\approx4\,747{,}47\approx4\,750$.
...
Řešení: rozdíl mezi $-7$ a $5$ je $12$, rozdělený na 2 díly $\implies$ 1 díl $=6$ jednotek. Mezi $5$ a $X$ jsou 3 díly $=18$ jednotek: $5+18=23$.

**5)** Uveďte všechna celá čísla, jejichž absolutní hodnota je menší než 3.

*Jaro 2015, příklad č. 2. Body: 1. Výsledek: $-2;-1;0;1;2$.*

Řešení: absolutní hodnota je vzdálenost obrazu čísla od obrazu čísla 0 (vždy $\geq0$). Hledáme celá čísla vzdálená od 0 méně než 3 jednotky: $-2,-1,0,1,2$ (čísla $-3$ a $3$ nevyhovují — jejich absolutní hodnota je přesně 3, ne méně).
...
Řešení: $-\sqrt3\approx-1{,}732$, vzdálenost od 1 $\approx2{,}732$. $-\dfrac\pi2\approx-1{,}57$, vzdálenost $\approx2{,}57$. $\dfrac\pi2\approx1{,}57$, vzdálenost $\approx0{,}57$. $\pi-1\approx2{,}14$, vzdálenost $\approx1{,}14$. $1-\pi\approx-2{,}14$, vzdálenost $\approx3{,}14$ — největší.
...
Řešení (dochovaný závěr): $1\,000m^3=1 \implies m^3=\dfrac1{1\,000} \implies m=\dfrac1{10}$.
...
Řešení (2. způsob — rozklad na prvočísla): $30=2\cdot3\cdot5$, $25=5\cdot5$, $180=2\cdot2\cdot3\cdot3\cdot5$. Z rozkladů vybereme nejpočetnější skupiny každého prvočísla (dvojek nejvíc v 180, trojek nejvíc v 180, pětek nejvíc v 25): $2\cdot2\cdot3\cdot3\cdot5\cdot5=900$.

**2i)** Určete reálné číslo $r=2|3-\pi|+|8-2\pi|$.

*2010 (1), příklad č. 2. Body: 1. Výsledek: $r=2$.*

Řešení: $\pi\approx3{,}14$, tedy $(3-\pi)$ je záporné: $|3-\pi|=\pi-3$. $(8-2\pi)$ je nezáporné: $|8-2\pi|=8-2\pi$. $r=2(\pi-3)+(8-2\pi)=2\pi-6+8-2\pi=2$.

**3i)** Vypočtěte $z\in\mathbb R$: $z=\log_318-\log_32$.
...
**5i)** Na číselné ose vyznačte interval $\langle2-n;n-3\rangle$ pro $n=5$.

*2012, příklad č. 1. Body: 1. Výsledek: $\langle-3;2\rangle$.*

Řešení: $2-5=-3$, $5-3=2$. Interval $\langle-3;2\rangle$ je uzavřený, krajní body jsou tedy vyznačeny plným kroužkem.

**6i)** Najděte nejmenší přirozené číslo $n$, pro které existuje interval $\langle2-n;n-3\rangle$.

*2012, příklad č. 2. Body: 1. Výsledek: $n=3$.*

Řešení: interval existuje, jen když je první číslo menší než druhé. $n=1$: $2-1=1$, $1-3=-2$ — nevyhovuje ($1>-2$). $n=2$: $0$, $-1$ — nevyhovuje. $n=3$: $2-3=-1$, $3-3=0$ — už vyhovuje ($-1<0$). Hledaný interval: $\langle-1;0\rangle$.

**7i)** Pro $a>0$ vypočtěte: $\log\dfrac4a-\log400+\log a$.
...
**10i)** a) Sestrojte množinu $P$ bodů se stejnou vzdáleností od přímek $p_1$, $p_2$. b) Sestrojte množinu $M$ bodů se stejnou vzdáleností od bodů $M_1$, $M_2$.

*2014 (2), příklad č. 15. Body: 2.*

Řešení: a) hledaná množina je **osa úhlu** sevřeného přímkami $p_1$, $p_2$.

b) hledaná množina je **osa úsečky** $M_1M_2$ (přímka procházející jejím středem, kolmá na ni).
