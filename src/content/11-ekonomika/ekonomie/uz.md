...
title: "UZ"
order: 12
source: "MATURITA HADR/Ekonomie/12.-UZ.docx"
---
= ubytovací zařízení \(UZ\) v ČR se rozděluje podle jednotné klasifikace __HOTELSTARS__ \(napr\.: czech tourism\), kterou organizuje __AHR ČR__ a další profesní organizace pod záštitou Ministerstva pro místní rozvoj\.
...
3. Pronajaté
4. Nezávislé
5. Řízené na základě smlouvy o řízení
...
- Drobný prodej
- Evidence
- Stížnosti hostů vyřizuje
- Spolupracuje s rezervacemi a housekeepingem
- Komunikuje s Policií ČR o příjezdu cizinců

__Požadavky na recepční:__
...
1. TOP MNG – např\.: finanční ředitel \(všech částí\)
2. STŘEDNÍ MNG – např\.: mng frontoffice \(částí\)
3. OPERATIVNÍ MNG – např\.: manažer recepce \(šéfkuchař\)

Top mng tvoří GENERÁLNÍ ŘEDITEL a ODBORNÍ ředitelé:

GENERÁLNÍ ŘEDITEL

EKONOMICÝ    FINANČNÍ    PROVOZNÍ    MKT\-OVÝ    PERSONÁLNÍ    TECHNICKÝ

Např\.: finanční ředitel \(náplň práce\)

- Vede účetnictví a evidenci hotelu
- Finanční kázeň a vymáhání pohledávek
- Vztahy s bankou \(zakládání účtů, čerpání úvěru…\)
- Inventarizace majetku
- Posuzuje vzniklé škody
- Platební kázeň \(faktury, závazky, odběratelé\)
- Splátkový kalendář

GR mývá svůj ŠTÁB, kde může být např\. právník, asistent, sekretářky

Střední mng – FnB mng

- Řídí a organizuje práci výrobních a odbytových středisek včetně zásobování
- Zpracovává rozpočet tržeb a nákladů
- Kontroluj hygienické a ostatní normy, jejich dodržování
- Sestavuje JL ve spolupráci s šéfkuchařem
- Kalkuluje a navrhuje ceny pokrmů
- Vybírá dodavatele
- Sestavuje čas\. Harmonogram odbyt\. střediska
- HACCP \(sestavuje příručku\)
- Organizuje a připravuje gastroakce
- Provádí analýzu JL z hlediska oblíbenosti pokrmů
- Sestavuje nabídky pro skupiny hostů
- Odpovídá za skaldové hospodářství \(zásobování \+ skladování\)

__Hotelová hospodyně se stará i o prádlo, které dělíme na:__
