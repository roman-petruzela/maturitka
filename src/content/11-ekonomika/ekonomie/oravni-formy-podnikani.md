---
title: "Orávní formy podnikání"
order: 23
source: "MATURITA HADR/Ekonomie/23. Orávní formy podnikání.odt"
---
Dělí se na: 	1\) Státní
...
__Organizace__ – založena za jiným účelem; nezisková

1. *Státní*

- Rozpočtová – veškeré náklady jsou hrazeny ze státního rozpočtu \(policie, armáda, škola, …\)
- Příspěvková – část nákladů si hradí sami a od státu dostávají příspěvky \(kulturní památky, divadla, muzea\)

1. *Ostatní* – církevní, občanská sdružení

__Korporace__

\-  podnikání PO dle občanského zákoníku
...
\- osobní účast na řízení				\- osobní účast se nevyžaduje
...
\- při úmrtí společníka musí zůstat alespoň 2, jinak zaniká a podíl společníka se dědí

\- všichni společníci mají zákaz konkurence \(=nemůžou mít jinou firmu se stejným zaměřením,

pokud není ve společenské smlouvě uvedeno jinak\)

\- zisk si společníci rozdělí rovným dílem \(není ve sp\. s\. uvedeno jinak\)
...
\- minimální základní kapitál je 1 Kč

\- rozdělení zisku – rozhoduje o tom valná hromada a zisk si dělí dle výše vkladu

\- zákaz konkurence platí pro jednatele a členy dozorčí rady

\- při změně společníka se společnost neruší, provede se změna v OR, protože společník může svůj podíl darovat, prodat nebo se dědí

__Akciové společnost \(a\. s\. / akc\. spol\.\)__

\- jde o společnost, kdy hodnota jejíhož majetku \(ZK\) je rozdělena na akcie

Akcie	\- majetkový CP, vyjadřuje část hodnoty majetku a\. s\.

\- vlastník akce je „akcionář“
...
\- při založení jsou vyžádány „stanovy“ \(=vnitřní předpisy, kterými se řídí a\. s\.\)

\- je povinná minimální výše 2 000 000 Kč \(80 000 eur\)

__Družstva__

\- b\. d\. – bytové družstvo

\- z\. d\. – zemědělské družstvo
...
\- zisk – podíly dle vkladu

\- družstvo je odlišné tím, že jde o neuzavřený počet členů

__Spojování podniků \(=konsorcium\)__

1. Sdružení podnikatelů

	\- nezapisuje se do OR, jde o účelové spojení na omezenou dobu

	\- sepisují smlouvu o sdružení

	\- vedou společné účetnictví

	\- zisk se dělí

1. Smlouva o tichém společníkovi

	\- osoba, která vloží kapitál/určitý vklad a má nárok na část zisku, ale podílí se i na ztrátě

	\- dle smlouvy o tichém společenství

	\- jméno tichého společníka se nikam nezapisuje \(ani do OR\)

__Státní podnik \(s\. p\.\)__

\- vyjímka BUDVAR – národní podnik
...
\- stát \(ministerstvo\) jmenuje ředitele – statutární orgán

\- stát vybaví státní podnik kapitálem a kontroluje hospodaření se státním majetkem a dozorčí radou

\- zapisuje se do OR

\- zisk se daní ; za závazky stát neručí
