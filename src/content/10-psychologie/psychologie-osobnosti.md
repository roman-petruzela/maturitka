...
source: "MATURITA HADR/PSYCHOLOGIE/PSYCHOLOGIE-OSOBNOSTI.docx"
---
...
- Dítě si nejprve uvědomuje své __tělové já__ \(dojmy z těla – mám ruce, mám nohy, … → odděluji se od svého prostředí\), postupně zaujímáme ke svému tělu určitý postoj
- V kontaktu s lidmi se utváří __vědomí sociálního já__ → postupně si uvědomujeme, že jsme sociální bytosti
...
- __Osobností__ je každý konkrétní živý člověk
...
__Pojem osobnost v běžném užívání__
...
__Dělení schopností__

- __Specifické –__ umožňují úspěšnost v určitém oboru \(hudební schopnosti, …\)
- __Obecné –__ slouží k uplatnění v běžném životě \(schopnost spolupráce, moudrost, …\)
...
2. Psychomotorické – pohybové \(rychlost, síla, obratnost, např\. gymnastika\)
3. Intelektuální – orientovat se v nových situacích, pohotově a pružně řešit problémy \(inteligence, rozumové schopnosti\)
...
- Pracoval na tomto úkolu 7 let, v roce 1905 zveřejnil __první inteligenční test__
...
__IQ NEMUSÍ BÝT V SOULADU SE ŠKOLNÍM PROSPĚCHEM__
...
- Souhrn všech skutečností, které __podporují__ nebo __tlumí__ jedince, aby něco dělal nebo naopak nedělal
- __Energizuje__ a __aktivizuje__ chování člověka
- Má také posilující, urychlující, usměrňující a výběrovou funkci
- Do procesu motivace se zapojuj __vědomé faktory__ \(potřeby, zájmy, hodnoty\) a __nevědomé mechanismy__ \(pudy, instinkty, návyky aj\.\)
...
__Motivace zahrnuje__

1. __Vnější činitele__
...
1. Určitá činnost jedince může být motivována různými motivy
...
1. Stejná činnost u různých jedinců může být motivována různými motivy
...
1. Člověk si uvědomuje pouze část svých motivů \(není schopen či není ochoten\)
...
- __Cílevědomé__ a __záměrné__ sebeovládání a sebeřízení, které vede k dosažení určitého cíle
- Způsobilost člověka __cílevědomě řídit__ svou duševní činnost a jejím prostřednictvím __regulovat__ průběh vlastní interakce s vnějším i vnitřním prostředím
...
__Silná x slabá vůle:__

- Silná a slabá vůle se vyhodnocuje na základě všech __volních vlastností__
- Silná vůle je souhrn minimálně větší poloviny kladných volních vlastností \(viz\. níže\)

__Volní vlastnosti__
...
1. __CHARAKTER__
	1. Podstatný znakem lidského charakteru je __jednání__ – charakter se projevuje v činech → důležitým znakem je to, že charakter se __„rodí“__ a je __spoluutvářen__ v sociálním kontextu
	2. Umožňuje kontrolu a řízení jednání člověka podle společenských, zejména morálních požadavků
	3. Formuje se vlivem výchovy __i působením sociálních vlivů__ a __zkušenosti__
	4. __Není vrozený__, ale osvojený v průběhu socializace a edukace\. Podstatné je zvnitřňování požadavků \(norem a hodnot\) sociálního okolí, společnosti
	5. Podle charakteru člověk jedná \(např\. se rozhoduje, zda bude lhát, zda bude svou práci vykonávat svědomitě, jestli se bude chovat slušně k druhým lidem\)
2. __TEMPERAMENT__
...
__Temperamentové teorie__

1. __Humorální teorie:__
...
1. __Konstituční typologie – E\. Kretschmer__
...
__Tři tělesné typy__ – pyknik, astenik, atletik

__Tři typy temperamentu –__ cyklotymní, schizotymní, viskózní
...
1. __Teorie H\.J\.Eysencka__

- Struktura osobnosti je tvořena 2 dimenzemi:

__Extroverze\-introverze__

__Extrovert__ – družný, má rád zábavu a společnost, touží po vzrušení, rád riskuje, vystavuje se nebezpečí, je impulzivní, rád vtipkuje, pohotově reaguje, má rád změnu, je bezstarostný, optimistický, je veselý

__Introvert__ – klidný, stažený, uzavřený, zdrženlivý, plánuje, nemá rád změny, spolehlivý, je vážný, dlouho rozmýšlí, kontroluje své city

*Extroverze*

__Neuroticismus__

1. __Nízký__ – osoba je stabilní, má minimální tendence emočně reagovat, rychle se vrací do stavu psychické rovnováhy, spokojená, klidná, vyrovnaná
2. __Vysoký__ – labilní, sklon k úzkosti, starostem, depresím, náladovosti, jedinec má problémy se spánkem, bývá emotivní, obtížně se uklidňuje
