---
title: "PowerPoint a Access"
order: 1
source: "MATURITA HADR/IT/20. a 25. PowerPoint a Access.docx"
---
__PowerPoint__

- je aplikací balíčku Microsoft Office sloužící ke kancelářským pracím, další je Word, Excel, Access, OneNote
- Program, který slouží k tvorbě a publikaci prezentací, které obsahují nadpisy a pod nimi nejdůležitější opěrné body přednášeného textu
- Na snímky můžeme vkládat různé vizualizační pomůcky pro zpestření prezentace posluchačům
...
- Předloha – složí k tomu aby rozmístění textových polí, obrázku, grafů a tabulek, bylo stejně uspořádané jako na ostatních snímcích stejného rozložení snímku; dále slouží k tomu, abychom nemuseli zadávat neustále stejné záhlaví a proto ho zadáme do předlohy a přenese se do celé prezentace
...
- je aplikací balíčku Microsoft Office sloužící ke kancelářským pracím, další je Word, Excel, Access, OneNote
- databáze je souhrn strukturovaných dat, s nimiž lze pomocí nějakého databázového systému manipulovat; nástroj pro shromažďování a uspořádávání informací
- každý řádek databáze se nazývá záznam; sloupcům tabulky se říká pole
- každá databáze musí obsahovat alespoň jeden primární klíč – jedinečná hodnota, která se v tabulce už nemůže opakovat
- filtr – slouží k organizaci dat v databázi v případě že pracujeme s tabulkou a potřebuje třídit různá pole
...
- Hlavním formátem aplikace MS Access je \.accdb
